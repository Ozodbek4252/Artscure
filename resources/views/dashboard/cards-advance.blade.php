...
>
  <head>
    ...
    <title>Cards Advance- UI elements | Frest - Bootstrap Admin Template</title>
                        ...
                        <tbody>
                            ...
                            <td class="pt-0">
                              <div class="d-flex justify-content-start align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                  <p class="mb-0 lh-1">*8490</p>
                                  <small class="text-muted text-nowrap">Credit Card</small>
                                </div>
                              </div>
                            </td>
                            <td class="pt-0">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex justify-content-start align-items-center">
                                ...
                                />
                                <div class="d-flex flex-column">
                                  <p class="mb-0 lh-1">*6345</p>
                                  <small class="text-muted text-nowrap">Paypal</small>
                                </div>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex justify-content-start align-items-center">
                                <img
                                  src="../../assets/img/icons/payments/amazon-light.png"
                                  alt="amazon"
                                  width="44"
                                  class="me-2"
                                  data-app-light-img="icons/payments/amazon-light.png"
                                  data-app-dark-img="icons/payments/amazon-dark.png"
                                />
                                <div class="d-flex flex-column">
                                  <p class="mb-0 lh-1">Amazon</p>
                                  <small class="text-muted text-nowrap">Wallet</small>
                                </div>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex justify-content-start align-items-center">
                                ...
                                />
                                <div class="d-flex flex-column">
                                  <p class="mb-0 lh-1">*6792</p>
                                  <small class="text-muted text-nowrap">Debit Card</small>
                                </div>
                              </div>
                            </td>
                            <td>
