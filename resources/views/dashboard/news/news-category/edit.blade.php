        ...
        <div class="card">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ Route('newsCategory.update', $news_category) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body d-flex">
                            <div class="col-md-2">
                                <label class="form-label" for="name_uz">{{__('body.Name')}} {{__('body.Uz')}}</label>
                                <input name="name_uz" value="{{ $news_category->name_uz }}" type="text" class="form-control"
                            ...
                            <div class="col-md-2 px-2">
                                ...
                                <input name="name_ru" value="{{ $news_category->name_ru }}" type="text" class="form-control"
                            ...
                            <div class="col-md-2">
                                ...
                                <input name="name_en" value="{{ $news_category->name_en }}" type="text" class="form-control"
