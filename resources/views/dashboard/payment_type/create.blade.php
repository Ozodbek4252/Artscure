...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            <span class="text-muted fw-light">{{__('body.Payment Types Create')}}
        </h4>
        ...
        <div class="card">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ Route('paymentTypes.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body d-flex">
                            <div class="col-md-2 mx-2">
                                <label class="form-label" for="name">{{__('body.Name')}}</label>
                                <input name="name" type="text" id="name" class="form-control" placeholder="{{__('body.Name')}}" />
                                @error('name')
